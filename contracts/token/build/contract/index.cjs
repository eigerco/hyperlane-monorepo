    ...
    this.circuits = {
      mint_to: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('mint_to',
  ...
  _mint_to_0(context, partialProofData, addr_0) {
    ...
    Contract._query(context,
                    ...
                    [
                     ...
                     { ins: { cached: true, n: 1 } }]);
    const newNonce_0 = this._evolveNonce_0(_descriptor_8.fromValue(Contract._query(context,
                                                                                   partialProofData,
                                                                                   [
                                                                                    { dup: { n: 0 } },
                                                                                    { idx: { cached: false,
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('token.compact line 20 char 9: cast from unsigned value to smaller unsigned value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
