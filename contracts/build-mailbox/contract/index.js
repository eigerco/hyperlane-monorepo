...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      dispatch: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('dispatch',
                                     'argument 1 (as invoked from Typescript)',
      ...
      deliver: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('deliver',
                                     'argument 1 (as invoked from Typescript)',
      ...
      delivered: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('delivered',
                                     'argument 1 (as invoked from Typescript)',
      ...
      latestDispatchedId: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('latestDispatchedId',
                                     'argument 1 (as invoked from Typescript)',
  ...
  _checkDelivered_0(context, partialProofData, messageId_0) {
    ...
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 1n)) {
      __compactRuntime.typeError('checkDelivered',
                                 'return value',
  ...
  _validateWithISM_0(context, partialProofData, message_0, metadata_0) {
    ...
    if (!(Array.isArray(result_0) && result_0.length === 0 )) {
      __compactRuntime.typeError('validateWithISM',
                                 'return value',
  ...
  _getZeroBytes_0(context, partialProofData) {
    ...
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('getZeroBytes',
                                 'return value',
  ...
  _getSender_0(context, partialProofData) {
    ...
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('getSender',
                                 'return value',
  ...
  _getLatestMessageId_0(context, partialProofData) {
    ...
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('getLatestMessageId',
                                 'return value',
