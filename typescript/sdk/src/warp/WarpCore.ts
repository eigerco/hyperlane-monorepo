...
export class WarpCore {
  ...
  async getLocalTransferFee({
    ...
    if (destinationMetadata.protocol === ProtocolType.Sovereign && destinationMetadata.bech32Prefix) {
      ...
      recipient = bytesToProtocolAddress(new Uint8Array([255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255]), destinationMetadata.protocol, destinationMetadata.bech32Prefix);
    } else {
